...
public class email {
    ...
    public static void sendEmail(String teaName,String receiveMailAccount,String content) throws Exception {
        ...
        //3.创建一封邮件
        MimeMessage message = createMimeMessage(session, myEmailAccount, receiveMailAccount,teaName,content);
     ...
     * @throws Exception
     */
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String teaName,String content) throws Exception {
        ...
        message.setContent("尊敬的"+teaName+"教员:<br/>   请查看本星期的课表 <br/> "+content+"", "text/html;charset=utf-8");
